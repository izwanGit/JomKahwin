          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <Icon className={`w-3.5 h-3.5 relative z-10 ${isActive ? 'text-[#D4AF37]' : 'text-[#FFFEFA]/60'}`} />
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center px-3 py-1.5 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37] ${
            ...
            >
              ...
              <Icon className={`w-4 h-4 relative z-10 transition-transform ${isActive ? 'scale-110 text-[#D4AF37]' : ''}`} />
              <span className={`text-[10px] font-medium mt-0.5 relative z-10 ${isActive ? 'font-bold text-[#FFFEFA]' : ''}`}>
                {item.label}
              </span>
            </button>
          );
