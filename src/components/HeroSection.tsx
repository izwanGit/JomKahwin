...
export const HeroSection: React.FC<HeroSectionProps> = ({ isOpened = true }) => {
  return (
    <section
      id="utama"
      ...
      >
        ...
        <IslamicArchCard>
          ...
          <motion.div
            ...
            animate={isOpened ? { opacity: 1, scale: 1, y: 0 } : { opacity: 0, scale: 0.92, y: 14 }}
          ...
          <motion.div
            ...
            transition={{ delay: 1.9, duration: 2.0, ease: [0.16, 1, 0.3, 1] }}
            style={{
              width: '100%',
              maxWidth: '440px',
